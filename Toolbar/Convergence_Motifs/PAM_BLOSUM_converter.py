...
def import_PAM_Matrix(PAM_Table='/Users/ugursahin/Desktop/EndProj/Toolbar/Aligners/PAM_and_BLOSOM_Matrices/PAM_table.csv'):
    f=open(PAM_Table,'r')
    file=f.readlines()
    PAM_list=[]
    for i in file:
...
def generate_GAP_inserted_PAM_BLOSUM(A='/Users/ugursahin/Desktop/EndProj/Toolbar/Aligners/PAM_and_BLOSOM_Matrices/PAM_table.csv'):
